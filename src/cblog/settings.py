...
DATABASES = {
    'default': {
        ...
        'HOST': 'database-1.cghc7dssqeii.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsprojectardablog' # please enter your s3 bucket name
